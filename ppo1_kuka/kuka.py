...
class Kuka:
    ...
    def reset(self):
        kuka_sdf_path = os.path.dirname(__file__)+"/kuka_iiwa/kuka_with_gripper2.sdf"
        # kuka_sdf_path = "/Doc/IM/kuka_iiwa/kuka_with_gripper2.sdf"
        objects = p.loadSDF(os.path.join(self.urdfRootPath, kuka_sdf_path))
        self.kukaUid = objects[0]
        # for i in range (p.getNumJoints(self.kukaUid)):
        #  print(p.getJointInfo(self.kukaUid,i))
        p.resetBasePositionAndOrientation(self.kukaUid, [-0.100000, 0.000000, 0.08000],
